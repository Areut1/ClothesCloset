...
public class AddInventoryReceipt extends View{
    ...
    private VBox createFormContent()
    {
        ...
        Text color1Label = new Text("Color1 : ");
        ...
        Text color2Label = new Text("Color2 : ");
...
public void populateFields()
{
    ...
    String bc = (String)newInventoryInfo.getState("barcode");
    barcode.setText(bc);
    String gen = (String)newInventoryInfo.getState("gender");
    gender.setText(gen);
    String siz = (String)newInventoryInfo.getState("size");
    size.setText(siz);
    String at = (String)newInventoryInfo.getState("articleType");
    articleType.setText(at);
    String c1 = (String)newInventoryInfo.getState("color1");
    color1.setText(c1);
    String c2 = (String)newInventoryInfo.getState("color2");
    color2.setText(c2);
    String bran = (String)newInventoryInfo.getState("brand");
    brand.setText(bran);
    String note = (String)newInventoryInfo.getState("notes");
    notes.setText(note);
    String stat = (String)newInventoryInfo.getState("status");
    status.setText(stat);
    String dln = (String)newInventoryInfo.getState("donorLastName");
    donorLastName.setText(dln);
    String dfn = (String)newInventoryInfo.getState("donorFirstName");
    donorFirstName.setText(dfn);
    String dphone = (String)newInventoryInfo.getState("donorPhone");
    donorPhone.setText(dphone);
    String demail = (String)newInventoryInfo.getState("donorEmail");
    donorEmail.setText(demail);
    String datedo = (String)newInventoryInfo.getState("dateDonated");
    dateDonated.setText(datedo);
